...
Engine.GameCanvas.prototype = {Initialize:function (a, b, c) {
...
Engine.KeyboardInput = {Pressed:[], Initialize:function () {
    var a = this;
...
Engine.Resources = {Images:{}, Sounds:{}, Destroy:function () {
    delete this.Images;
    delete this.Sounds;
    return this
...
Engine.GameStateContext.prototype = {ChangeState:function (a) {
...
Engine.GameState.prototype = {Enter:function () {
}, Exit:function () {
}, Update:function () {
}, Draw:function () {
...
Engine.GameTimer.prototype = {Start:function () {
...
Engine.DrawableManager.prototype = {Add:function (a) {
    this.Objects.push(a);
    this.Unsorted = !0
}, AddRange:function (a) {
...
Engine.Collideable.prototype = {Update:function () {
    this.X = this.Base.X;
    this.Y = this.Base.Y
...
Engine.Application.prototype = {Update:function (a) {
