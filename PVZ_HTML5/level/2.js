oS.Init({PName:[oPeashooter, oSunFlower], ZName:[oZombie, oZombie2, oZombie3], PicArr:function () {
...
}(), backgroundImage:"images/interface/background1unsodded_1.jpg", LF:[0, 0, 1, 1, 1, 0], CanSelectCard:0, LevelName:"关卡 1-2", LargeWaveFlag:{6:$("imgFlag1")}, InitLawnMower:function () {
    var a = 5;
    while (--a > 1) {
        CustomSpecial(oLawnCleaner, a, -1)
    }
}, StartGame:function () {
    NewEle("sod3row", "div", "position:absolute;left:119px;top:163px;height:330px;width:46px;z-index:1;background:url(images/interface/sod3row.png);over-flow:hidden", 0, EDAll);
                ...
                oP.Monitor({ar:[0], f:function (l) {
                    ...
                    switch (l) {
                        ...
                        default:
                            ...
                            k > 2 ? (innerText($("DivTeach"), "现在用你获得的阳光种植其它的植物！"), SetStyle($("PointerUD"), {left:"50px", top:"60px"}), oSym.addTask(500, SetNone, [$("PointerUD"), $("DivTeach")])) : oSym.addTask(10, arguments.callee, [3])
                    }
                    return l
                }});
                BeginCool();
    ...
    [oZombie2, 2, 1],
    [oZombie3, 2, 1]
], FlagNum:6, FlagToSumNum:{a1:[3, 5], a2:[1, 2, 4]}, FlagToMonitor:{5:[ShowFinalWave, 0]}, FlagToEnd:function () {
    NewImg("imgSF", "images/Card/Plants/CherryBomb.png", "left:827px;top:220px", EDAll, {onclick:function () {
