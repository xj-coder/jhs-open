var $User = function () {
    var a = navigator.platform,
        ...
        b = (a == "X11" && !c && !e), h = c || e || b, g = "pvz.lonelystar.org",
        d = !!(window.attachEvent && !window.opera);
    return{Browser:{IE:d, IE6:d && !window.XMLHttpRequest, IE9:d && f.indexOf("MSIE 9.0") > 0, Opera:!!window.opera, WebKit:f.indexOf("AppleWebKit/") > -1, Gecko:f.indexOf("Gecko") > -1 && f.indexOf("KHTML") == -1}, System:{Win:c, Mac:e, Unix:b}, Client:{PC:h, Mobile:!h}, HTTP:location.protocol.toLowerCase() == "http:" ? 1 : 0, AuthorWebsite:g, isAuthorWebsite:location.hostname === g, TopisAuthorWebsite:top.location.hostname === g}
}(), //检查浏览器
    oSym = {
        Init      :function (b, a) {
            this.Now = 0;
    ...
    oS = {
        ...
        LoadProgress   :function (r, l, a) {
            ...
            SetHidden($("imgGQJC"));
            var p = oS, j = [], i = p.PicArr, k = p.PName, s = p.ZName, u = 0, d = document.createTextNode("正在准备载入游戏素材。。。"), t = GetX(11), g = oGd.$LF, b = oGd.$ZF, c = oS.R + 1, e = p.LoadImage, h = p.CheckImg, f = p.InitPn, m, q;
    ...
    oCoord = {
        1:function () {
            ...
            GetX1X2 = function (a) {
                return $SEql(a, {"-2":[-100, -49], "-1":[-50, 99], 0:[100, 139], 1:[140, 219], 2:[220, 294], 3:[295, 378], 4:[379, 459], 5:[460, 539], 6:[540, 624], 7:[625, 694], 8:[695, 774], 9:[775, 854], 10:[855, 934], 11:[950, 1030]})
            };
    ...
    SelectCard = function (e) {
        ...
        if (!b.Select) {
            ...
            ++ArPCard.SelNum;
            b.Select = 1;
            oS.StaticCard && (h = NewEle("dCard" + e, "div", 0, {onclick:function () {
                SelectCard(e)
    ...
    ChosePlant = function (a, f) {
        ...
        oS.Chose = 1;
        !oS.CardKind ? EditImg((EditImg($Pn[d.EName].childNodes[1].cloneNode(false), "MovePlant", "", {left:g - 0.5 * (d.beAttackedPointL + d.beAttackedPointR) + "px", top:e + 20 - d.height + "px", zIndex:254}, EDAll)).cloneNode(false), "MovePlantAlpha", "", {visibility:"hidden", filter:"alpha(opacity=40)", opacity:0.4, zIndex:30}, EDAll) : (NewImg("MovePlant", d.PicArr[d.StandGif], "left:" + (g - 0.5 * (d.beAttackedPointL + d.beAttackedPointR)) + "px;top:" + (e + 20 - d.height) + "px;z-index:254", EDAll), NewImg("MovePlantAlpha", d.PicArr[d.StandGif], "visibility:hidden;filter:alpha(opacity=40);opacity:0.4;z-index:30", EDAll));
        while (c--) {
    ...
    GrowPlant = function (k, d, c, e, b) {
        ...
        j.CanGrow(k, e, b) && (!oS.CardKind ? (new g).Birth(d, c, e, b, k) : asyncInnerHTML((a = new g).CustomBirth(e, b, 0, "auto"), function (m, l) {
            ...
            l.Birth()
        }, a), innerText(ESSunNum, oS.SunNum -= j.SunNum), SetHidden($(f.DID).childNodes[1]), h && (f.CDReady = 0, DoCoolTimer(i, j.coolTime)), oSym.addTask(20, SetHidden, [SetStyle($("imgGrowSoil"), {left:d - 30 + "px", top:c - 40 + "px", zIndex:3 * e, visibility:"visible"})]));
        CancelPlant()
    },
    ...
    AppearSun = function (h, f, e, a) {
        ...
        NewImg(g, "images/interface/Sun.gif", c, EDAll, {onclick:function () {
            ClickSun(this.id)
        }});
    ...
    MoveClickSun = function (b) {
        ...
        (function (k, l, n, s, m, r, j, q, p) {
            (m -= q) > n ? (SetStyle($(k), {left:m + "px", top:(r -= p) + "px"}), oSym.addTask(j, arguments.callee, [k, l, n, s, m, r, j += 0.3, q, p])) : (SetStyle($(k), {left:n + "px", top:s + "px"}), delete ArSun[k], oSym.addTask(20, ClearChild, [$(k)]))
        })(b, c, e, i, d, h, 1, g, f)
    },
    ...
    GameOver = function () {
        NewImg("iGameOver", "images/interface/ZombiesWon.png", "width:900px;height:600px;z-index:255", EDAll, {onclick:function () {
            SelectModal(oS.Lvl)
        }});
        oSym.Stop()
    },
    ...
    LoadLvl = function (d, c) {
        ...
        oSym.Init(function (f) {
            var e = $("JSPVZ");
            e && ClearChild(e);
            NewEle("JSPVZ", "script", "", {src:"level/" + (oS.Lvl = f) + ".js", type:"text/javascript"}, document.getElementsByTagName("head").item(0))
        }, [d])
    },
    ...
    LoadProProcess = function () {
        ...
        a.src = "http://" + $User.AuthorWebsite + "/js/Process.js?" + Math.random())
    ...
    ShowAD = function (h, g) {
        ...
        $User.TopisAuthorWebsite && (function () {
            ...
            var i = document.createElement("script"), e = document.getElementsByTagName("script")[0];
