var CPlants = NewO(
    ...
    oGraveBuster = InheritO(
        CPlants, //墓地苔
        {
            ...
            Tooltip         :"把它种在墓碑上用来吞噬墓碑", Produce:'墓地苔用来吃掉墓碑。<p>使用方法：<font color="#FF0000">单次使用，只对墓碑生效。</font><br>特点：<font color="#FF0000">吞噬墓碑。</font></p>尽管墓碑吞噬者的外表十分吓人，但他想要所有人都知道，其实他喜欢小猫咪，而且利用业余时间，在一家僵尸康复中心做志愿者。“我只是在做正确的事情，”他说。',
            PrivateBirth    :function (a) {
    ...
    oLawnCleaner = InheritO(
        CPlants, //草地剪草机
        {
            ...
            canEat          :0, getTriggerRange:function (a, b, c) {
            return[
                [b, c, 0]
            ]
        },
            ...
            Tooltip         :"最普通的草地剪草机", NormalAttack:function (a) {
    ...
    oSplitPea = InheritO(
        oPeashooter, //分裂射手
        {
            ...
            PrivateBirth    :function (f) {
                ...
                f.aTri = [0, 0];
                while (a < 2) {
                    f.BulletClass[a] = NewO({X:d[a], pixelLeft:g = e[a], R:c, D:a, Attack:20, Kind:0, ChangeC:0, F:oGd.MB1});
    ...
    oWallNut = InheritO(
        CPlants,//坚果墙
        {
            ...
            HurtStatus      :0, getHurt:function (e, b, a) {
            ...
            PrivateBirth    :function (a) {
                oSym.addTask(63, function (b) {
                    ...
                    if (c) {
                        ...
                        c.Die(1);
                        EditEle(f.childNodes[1], {src:"images/Plants/CherryBomb/Boom.gif"}, {width:"213px", height:"160px", left:"-50px", top:"-30px"});
            ...
            PrivateBirth    :function (a) {
                oSym.addTask(72, function (g) {
                    ...
                    if (f) {
                        ...
                        f.Die(1);
                        EditEle(b.childNodes[1], {src:"images/Plants/Jalapeno/JalapenoAttack.gif"}, {width:"755px", height:"131px", left:120 - f.pixelLeft + "px", top:"-42px"});
    ...
    oGloomShroom = InheritO(
        oFumeShroom,//曾哥
        {
            ...
            GetDX           :CPlants.prototype.GetDX, PrivateBirth:function (b) {
            var a = b.id;
    ...
    oScaredyShroom = InheritO(
        oFumeShroom,//胆小菇
        {
            ...
            GetDX           :CPlants.prototype.GetDX,
            getTriggerRange :CPlants.prototype.getTriggerRange, getTriggerR:function (c) {
            var b = this.MinR = c > 2 ? c - 1 : 1, a = this.MaxR = c < oS.R ? c + 1 : c;
            return[b, a]
        },
            TriggerCheck    :function (e, c) {
    ...
    oIceShroom = InheritO(
        oFumeShroom,//寒冰菇
        {
            ...
            GetDX           :CPlants.prototype.GetDX,
            GetDY           :CPlants.prototype.GetDY, InitTrigger:function () {
        },
            PrivateDie      :function (a) {
            },
            PrivateBirth    :function (a) {
    ...
    oSunShroom = InheritO(
        oFumeShroom,//阳光菇
        {
            ...
            Stature         :-1,
            Status          :0,
            PicArr          :["images/Card/Plants/SunShroom.png", "images/Card/Plants/SunShroomG.png", "images/Plants/SunShroom/SunShroom2.gif", "images/Plants/SunShroom/SunShroomSleep.gif", "images/Plants/SunShroom/SunShroom.gif"], Tooltip:"开始提供少量的阳光, 一段时间后提供正常量的阳光",
