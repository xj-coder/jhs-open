oS.Init(
    {
        ...
        LevelName      :"关卡 1-1",
        LoadMusic      :function () {
            NewMusic("UraniwaNi.swf")
        },
        InitLawnMower  :function () {
            CustomSpecial(oLawnCleaner, 3, -1)
        },
        StartGame      :function () {
            NewEle("sod1row", "div", "position:absolute;left:132px;top:280px;height:117px;width:0;z-index:1;background:url(images/interface/sod1row.png);over-flow:hidden", 0, EDAll);
                    ...
                    oP.Monitor({ar:[0], f:function (k) {
                        ...
                        switch (k) {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                oS.SunNum > 99 && (innerText($("DivTeach"), "你拥有了足够的阳光来种植另一个豌豆射手！"), EditImg($("PointerUD"), "", "images/interface/PointerUP.gif", {left:"50px", top:"60px", visibility:"visible"}), ++k);
                                oSym.addTask(10, arguments.callee, [k]);
                                break;
                            default:
                                var j = 0, h = oGd.$;
