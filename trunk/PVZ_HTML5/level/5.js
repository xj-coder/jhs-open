oS.Init({PName:[oPeashooter, oSunFlower, oCherryBomb, oWallNut], ZName:[oZombie, oZombie2, oZombie3, oConeheadZombie], PicArr:function () {
...
}(), backgroundImage:"images/interface/background1.jpg", CanSelectCard:0, LevelName:"1-5 特别关：陨石坑", LargeWaveFlag:{10:$("imgFlag1")}, StartGameMusic:"Watery Graves.swf", StartGame:function () {
    SetHidden($("dSunNum"));
    SetVisible($("tdShovel"), $("dTop"));
    NewEle("DivTeach", "div", 0, 0, EDAll);
    oP.Monitor({ar:[0], f:function (c) {
        ...
        var c = Math.floor(1 + Math.random() * 5), f = Math.floor(1 + Math.random() * 9), g = GetX(f) - 55, e = GetY(c) - 60, b = c + "_" + f, a = oP.FlagZombies, d;
        switch (true) {
            case a > 3:
    ...
    NewImg("imgSF", "images/Card/Plants/PotatoMine.png", "left:587px;top:270px", EDAll, {onclick:function () {
