oS.Init({PName:[oPeashooter, oSunFlower, oCherryBomb, oWallNut], ZName:[oZombie, oZombie2, oZombie3, oConeheadZombie], PicArr:["images/interface/background1unsodded2.jpg", "images/interface/background1.jpg"], backgroundImage:"images/interface/background1unsodded2.jpg", CanSelectCard:0, LevelName:"关卡 1-4", LargeWaveFlag:{9:$("imgFlag1")}, StartGame:function () {
    NewEle("sod3row", "div", "position:absolute;left:-115px;top:0;height:600px;width:264px;z-index:0;background:url(images/interface/background1.jpg);over-flow:hidden", 0, EDAll);
    NewImg("SodRoll_1", "images/interface/SodRoll.png", "left:122px;top:48px;z-index:1", EDAll);
    NewImg("SodRollCap_1", "images/interface/SodRollCap.png", "left:117px;top:131px;z-index:1", EDAll);
    NewImg("SodRoll_2", "images/interface/SodRoll.png", "left:122px;top:428px;z-index:1", EDAll);
    NewImg("SodRollCap_2", "images/interface/SodRollCap.png", "left:117px;top:511px;z-index:1", EDAll);
    ...
    [oZombie3, 2, 1],
    [oConeheadZombie, 2, 1]
], FlagNum:9, FlagToSumNum:{a1:[3, 5, 8], a2:[1, 2, 3, 10]}, FlagToMonitor:{8:[ShowFinalWave, 0]}, FlagToEnd:function () {
