oS.Init({PName:[oPeashooter, oPotatoMine, oSquash, oCherryBomb, oJalapeno], ZName:[oZombie], PicArr:["images/interface/background1.jpg"], backgroundImage:"images/interface/background1.jpg", CanSelectCard:0, SunNum:100, LevelName:"小游戏：你的心脏够强劲吗？", LargeWaveFlag:{1:$("imgFlag1")}, StartGameMusic:"Watery Graves.swf", StartGame:function () {
    ...
    oP.Monitor({ar:[0], f:function () {
        var c = $User.Browser, b = function () {
        ...
        (c.IE9 || !c.IE) && (oS.LvlClearFunc = function () {
            ...
            var i = oP, g = [], f = 1, j = i.ArZ, m = [], k = [], e = 30, d = EDZombies.cloneNode(true);
    ...
    [oZombie, 30, 1]
], FlagNum:1, FlagToSumNum:{a1:[], a2:[1000]}, FlagToMonitor:{1:[ShowFinalWave, 0]}});