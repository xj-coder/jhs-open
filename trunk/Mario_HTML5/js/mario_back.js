var Mario = {SpriteCuts:{CreateBlackFont:function () {
    ...
    return new Engine.SpriteFont([],
        Engine.Resources.Images.font, 8, 8, this.GetCharArray(32))
    ...
    for (var a =
        [], b = 0, c = 0, e = Engine.Resources.Images.background.width / 32, d = Engine.Resources.Images.background.height / 32, b = 0; b < e; b++) {
        a[b] = [];
    ...
    return a
}}, Tile:{BlockUpper:1, BlockAll:2, BlockLower:4, Special:8, Bumpable:16, Breakable:32, PickUpable:64,
    Animated:128, Behaviors:[], LoadBehaviors:function () {
        ...
        this.Behaviors = a
    }}, LevelType:{Overground:0, Underground:1, Castle:2}, Odds:{Straight:0, HillStraight:1, Tubes:2, Jump:3, Cannons:4}, Level:function (a, b) {
    this.Width = a;
    this.Height = b;
...
Mario.Level.prototype = {Update:function () {
...
Mario.BackgroundGenerator.prototype = {SetValues:function (a, b, c, e) {
    this.Width = a;
    this.Height = b;
    this.Distant = c;
    this.Type = e
...
Mario.BackgroundRenderer.prototype.Draw = function (a, b) {
    for (var c = b.X / this.Distance, e = 0, d = 0, f = null, f = null, g = (c + this.Width) / 32 | 0, e = c / 32 | 0; e <= g; e++)for (d = 0; d < this.TilesY; d++)f = this.Level.GetBlock(e, d) & 255, f = this.Background[f % 8][f / 8 | 0], a.drawImage(Engine.Resources.Images.background, f.X, f.Y, f.Width, f.Height, (e << 5) - c | 0, d << 5 | 0, f.Width, f.Height)
};
Mario.ImprovedNoise = function (a) {
    this.P = [];
    this.Shuffle(a)
};
Mario.ImprovedNoise.prototype = {Shuffle:function () {
    ...
    b -= b | 0;
    c -= c | 0;
    var g = this.Fade(a), h = this.Fade(b), i = this.Fade(c), j = this.P[e] + d, k = this.P[j] + f, j = this.P[j + 1] + f, d = this.P[e + 1] + d, e =
...
Mario.Character.prototype.Blink = function (a) {
    ...
    this.Large ? (this.Image = this.Fire ? Engine.Resources.Images.fireMario : Engine.Resources.Images.mario, this.XPicO = 16, this.YPicO = 31, this.PicWidth = this.PicHeight = 32) : (this.Image = Engine.Resources.Images.smallMario, this.XPicO = 8, this.YPicO = 15, this.PicWidth = this.PicHeight = 16)
};
Mario.Character.prototype.Move = function () {
    if (this.WinTime > 0)this.WinTime++, this.Ya = this.Xa = 0; else if (this.DeathTime > 0)this.DeathTime++, this.DeathTime < 11 ? this.Ya = this.Xa = 0 : this.DeathTime === 11 ? this.Ya = -15 : this.Ya += 2, this.X += this.Xa, this.Y += this.Ya; else if (this.PowerUpTime !== 0) {
        ...
        if (this.Xa < -2)this.Facing = -1;
        if (Engine.KeyboardInput.IsKeyDown(Engine.Keys.S) || this.JumpTime < 0 && !this.OnGround && !this.Sliding)if (this.JumpTime < 0)this.Xa = this.XJumpSpeed, this.Ya = -this.JumpTime * this.YJumpSpeed, this.JumpTime++;
        else if (this.OnGround && this.MayJump)Engine.Resources.PlaySound("jump"), this.XJumpSpeed = 0, this.YJumpSpeed = -1.9, this.JumpTime = 7, this.Ya = this.JumpTime * this.YJumpSpeed, this.Sliding = this.OnGround = !1; else if (this.Sliding && this.MayJump)Engine.Resources.PlaySound("jump"), this.XJumpSpeed = -this.Facing * 6, this.YJumpSpeed = -2, this.JumpTime = -6, this.Xa = this.XJumpSpeed, this.Ya = -this.JumpTime * this.YJumpSpeed, this.Sliding = this.OnGround = !1, this.Facing = -this.Facing; else {
        ...
        if (!Engine.KeyboardInput.IsKeyDown(Engine.Keys.Left) && !Engine.KeyboardInput.IsKeyDown(Engine.Keys.Right) || this.Ducking || this.Ya < 0 || this.OnGround)this.Sliding =
            !1;
        Engine.KeyboardInput.IsKeyDown(Engine.Keys.A) && this.CanShoot && this.Fire && this.World.FireballsOnScreen < 2 && (Engine.Resources.PlaySound("fireball"), this.World.AddSprite(new Mario.Fireball(this.World, this.X + this.Facing * 6, this.Y - 20, this.Facing)));
...
Mario.Character.prototype.GetHurt = function () {
    if (!(this.DeathTime > 0 || this.World.Paused) && !(this.InvulnerableTime > 0))this.Large ? (this.World.Paused = !0, this.PowerUpTime = -18, Engine.Resources.PlaySound("powerdown"), this.Fire ? this.SetLarge(!0, !1) : this.SetLarge(!1, !1), this.InvulnerableTime = 32) : this.Die()
};
...
Mario.LevelRenderer.prototype.DrawStatic = function (a, b) {
    for (var c = 0, e = 0, d = 0, d = null, f = (b.X + this.Width) / 16 | 0, c = b.X / 16 | 0; c < f + 1; c++)for (e = 0; e < this.TilesY; e++)d = this.Level.GetBlock(c, e) & 255, (Mario.Tile.Behaviors[d] & Mario.Tile.Animated) === 0 && (d = this.Background[d % 16][d / 16 | 0], a.drawImage(Engine.Resources.Images.map, d.X, d.Y, d.Width, d.Height, (c << 4) - b.X | 0, e << 4 | 0, d.Width, d.Height))
};
...
Mario.LevelRenderer.prototype.DrawExit0 = function (a, b, c) {
    for (var e = 0, e = 0, d = null, e = this.Level.ExitY - 8; e < this.Level.ExitY; e++)d = this.Background[12][e === this.Level.ExitY - 8 ? 4 : 5], a.drawImage(Engine.Resources.Images.map, d.X, d.Y, d.Width, d.Height, (this.Level.ExitX << 4) - b.X - 16, (e << 4) - b.Y, d.Width, d.Height);
    c && (e = this.Level.ExitY * 16 - 48 - Math.sin(this.AnimTime) * 48 - 8, d = this.Background[12][3], a.drawImage(Engine.Resources.Images.map, d.X, d.Y, d.Width, d.Height, (this.Level.ExitX << 4) - b.X - 16, e - b.Y, d.Width, d.Height), d = this.Background[13][3],
...
Mario.LevelRenderer.prototype.DrawExit1 = function (a, b) {
    for (var c = 0, e = null, c = this.Level.ExitY - 8; c < this.Level.ExitY; c++)e = this.Background[13][c === this.Level.ExitY - 8 ? 4 : 5], a.drawImage(Engine.Resources.Images.map, e.X, e.Y, e.Width, e.Height, (this.Level.ExitX << 4) - b.X + 16, (c << 4) - b.Y, e.Width, e.Height)
};
...
Mario.LevelGenerator.prototype = {CreateLevel:function (a, b) {
...
Mario.SpriteTemplate.prototype = {Spawn:function (a, b, c, e) {
...
Mario.TitleState.prototype.Enter = function () {
    ...
    var a = new Mario.BackgroundGenerator(2048, 15, !0, Mario.LevelType.Overground), b = new Mario.BackgroundRenderer(a.CreateLevel(), 320, 240, 2);
...
Mario.TitleState.prototype.CheckForChange = function (a) {
    Engine.KeyboardInput.IsKeyDown(Engine.Keys.S) && a.ChangeState(Mario.GlobalMapState)
};
...
Mario.LoadingState.prototype.Enter = function () {
    ...
    (new Audio).canPlayType("audio/mp3") ? Engine.Resources.AddSound("1up", "sounds/1-up.mp3", 1).AddSound("breakblock", "sounds/breakblock.mp3").AddSound("bump", "sounds/bump.mp3", 4).AddSound("cannon", "sounds/cannon.mp3").AddSound("coin", "sounds/coin.mp3", 5).AddSound("death", "sounds/death.mp3",
...
Mario.LoadingState.prototype.Update = function (a) {
    if (!this.ImagesLoaded) {
        this.ImagesLoaded = !0;
        for (var b = 0, b = 0; b < this.Images.length; b++)if (Engine.Resources.Images[this.Images[b].name].complete !== !0) {
            this.ImagesLoaded = !1;
            break
        }
    }
...
Mario.WinState.prototype.Update = function (a) {
    this.drawManager.Update(a);
    if (this.waitTime > 0)this.waitTime -= a; else if (Engine.KeyboardInput.IsKeyDown(Engine.Keys.S))this.wasKeyDown = !0
};
...
Mario.MapState.prototype.Update = function (a) {
    ...
    if (this.WorldNumber !== 8) {
        ...
        if (this.MoveTime > 0)this.MoveTime--; else {
            ...
            if (this.CanEnterLevel && Engine.KeyboardInput.IsKeyDown(Engine.Keys.S) && this.Level[b][c] === Mario.MapTile.Level && this.Data[b][c] !== -11 && this.Level[b][c] === Mario.MapTile.Level && this.Data[b][c] !== 0 && this.Data[b][c] >
                -10) {
...
Mario.LevelState.prototype.Bump = function (a, b, c) {
    ...
    (Mario.Tile.Behaviors[e & 255] & Mario.Tile.Bumpable) > 0 && (this.BumpInto(a, b - 1), this.Level.SetBlock(a, b, 4), this.Level.SetBlockData(a, b, 4), (Mario.Tile.Behaviors[e & 255] & Mario.Tile.Special) > 0 ? (Engine.Resources.PlaySound("sprout"), Mario.MarioCharacter.Large ? this.AddSprite(new Mario.FireFlower(this, a * 16 + 8, b * 16 + 8)) : this.AddSprite(new Mario.Mushroom(this, a * 16 + 8, b * 16 + 8))) : (Mario.MarioCharacter.GetCoin(), Engine.Resources.PlaySound("coin"),
