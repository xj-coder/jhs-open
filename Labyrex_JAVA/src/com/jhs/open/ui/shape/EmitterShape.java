...
public class EmitterShape extends Canvas {
	...
	public EmitterShape(EmitterBean bean) {
	...
	public void reset(EmitterBean bean) {
		this.bean = bean;
		reset();
	}
	...
	public void render(Graphics g) {
		...
		if (owner != null) {
			g.drawImage(ImgSelector.emitterSelector(this, new Rect2D(owner.x, owner.y, owner.width, owner.height)),
